...
export const LAB_FIELD_SPECS: Record<string, LabFieldSpec> = {
  literature_review: {
    ...
    blurb: "A themed map of what's already been published.",
    coreLabel: "Topic or question",
  ...
  theoretical_framework: {
    ...
    blurb: "A model that explains why something happens.",
    coreLabel: "What you want to explain",
    coreDescription: "Name the thing the model should explain.",
  ...
  research_proposal: {
    ...
    blurb: "A plan for a study you want to run.",
    coreLabel: "Research question",
    coreDescription: "The main question. Start with What, How, or Why.",
  ...
  discussion: {
    id: "discussion",
    blurb: "The Discussion section for a study you've already run.",
    coreLabel: "Results to discuss",
    coreDescription: "Your findings — direction and key numbers.",
  ...
  introduction: {
    id: "introduction",
    blurb: "The opening section of your paper.",
    coreLabel: "Central claim",
    coreDescription: "The one sentence the intro builds up to.",
  ...
  conclusion: {
    id: "conclusion",
    blurb: "The closing section of your paper.",
  ...
  abstract: {
    id: "abstract",
    blurb: "A short abstract (150–250 words).",
    coreLabel: "One-sentence gist",
    coreDescription: "If you had one sentence, what's the paper about?",
  ...
  personal_statement: {
    ...
    blurb: "A personal essay for grad school, scholarships, or job applications.",
    coreLabel: "Your motivation",
    coreDescription: "Why you're drawn to this — the essay's through-line. One short paragraph.",
  ...
  resume: {
    id: "resume",
    blurb: "A resume / CV tuned for student and early-career applications. ATS-friendly.",
    coreLabel: "Target role and level",
    coreDescription: "The role you're applying for and your stage. Sets the tone of the document.",
